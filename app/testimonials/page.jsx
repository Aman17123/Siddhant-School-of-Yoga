...
export const metadata = {
  title: "Student Testimonials | Siddhant School of Yoga, Rishikesh",
  description:
    "Read what students from around the world say about their experience at Siddhant School of Yoga in Rishikesh, India.",
};
            ...
            <div className="flex flex-col lg:flex-row lg:items-center gap-10 lg:gap-16">
              <div className="w-full lg:w-1/2 max-w-xl text-left">
                ...
                >
                  ...
                  <span className="text-[#142b1e] font-semibold">Testimonials</span>
                </nav>
                ...
                <p className="mt-3 text-sm sm:text-[15px] font-figtree font-medium text-[#142b1e]/90 leading-relaxed max-w-md">
                  Real stories from students who trained with us in Rishikesh — hear what they have to say about their transformation.
                </p>
              </div>
              ...
              <div className="w-full lg:w-1/2 py-0 sm:py-6 lg:py-16">
                <div className="relative w-full aspect-[16/9] rounded-3xl overflow-hidden shadow-xl border-4 border-white">
                  <Image
                    ...
                    alt="Yoga teacher training graduates celebrating at Siddhant School of Yoga"
                    fill
                    priority
