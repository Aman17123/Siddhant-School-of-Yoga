...
export default function PaymentPage() {
  return (
    <div className="flex flex-col min-h-screen relative selection:bg-[#1c3b2b]/30 selection:text-[#142b1e]">
      ...
      <main className="flex-grow bg-[#f4efe6]">
        <section className="py-14 sm:py-16 lg:py-20">
          <Container>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto mb-12">
              {/* Bank Transfer */}
              <div className="p-6 rounded-2xl bg-[#fdfbf7] border border-[#e3dac9] shadow-xs">
                <div className="w-11 h-11 rounded-xl bg-[#1c3b2b]/10 text-[#1c3b2b] flex items-center justify-center mb-3">
            ...
            {/* Trust note */}
            <div className="max-w-3xl mx-auto flex items-start gap-3 p-4 sm:p-5 rounded-2xl bg-[#1c3b2b]/5 border border-[#1c3b2b]/20 mb-12">
            ...
            <div className="max-w-2xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3.5">
                <a
                  ...
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 bg-[#1c3b2b] hover:bg-[#142b1e] text-white text-sm sm:text-base font-bold font-figtree px-8 py-4 rounded-full shadow-md hover:shadow-lg transition-all duration-300 hover:scale-105"
                >
                ...
                <a
                  ...
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 bg-[#fdfbf7] border-2 border-[#1c3b2b] text-[#1c3b2b] hover:bg-[#1c3b2b] hover:text-white text-sm sm:text-base font-bold font-figtree px-8 py-3.5 rounded-full transition-all duration-300 hover:scale-105"
                >
