...
export default function WhyRishikesh() {
  ...
  return (
    <section
      id="rishikesh"
      className="pt-14 sm:pt-16 lg:pt-20 pb-20 sm:pb-24 lg:pb-28 bg-[#FFFFFF] border-b border-[#EBE5D8]/60 relative overflow-hidden"
    >
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 text-center lg:text-left">
            ...
            <p className="font-figtree text-sm sm:text-base text-stone-600 leading-relaxed mb-8 font-light max-w-2xl mx-auto lg:mx-0">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 font-figtree">
              {highlights.map((h, idx) => {
                ...
                return (
                  <div
                    key={idx}
                    className="p-5 rounded-2xl bg-white border border-[#EBE5D8] shadow-xs hover:shadow-md transition-shadow flex flex-col items-center sm:items-start text-center sm:text-left"
                  >
                    <div className="w-10 h-10 rounded-xl bg-[#f22924]/10 text-[#f22924] flex items-center justify-center mb-3 mx-auto sm:mx-0">
          ...
          <div className="lg:col-span-5 relative">
            ...
            <div
              className="absolute -inset-6 bg-gradient-to-tr from-[#f22924]/10 via-[#F5B860]/12 to-transparent rounded-[40px] blur-2xl pointer-events-none -z-10"
              aria-hidden="true"
            />
            ...
            <div className="absolute -inset-4 sm:-inset-6 pointer-events-none -z-10 flex items-center justify-center overflow-visible">
              <svg
                viewBox="0 0 500 500"
                className="w-[110%] h-[110%] max-w-none text-[#F5B860] opacity-20 sm:opacity-28 transition-opacity"
                fill="none"
              ...
              >
                ...
                {[
                  ...
                  <g key={i} transform={`rotate(${angle} 250 250)`}>
                    ...
                    <line
                      ...
                      strokeLinecap="round"
                    />
                    <circle cx="250" cy="16" r="2.5" fill="#F5B860" opacity="0.8" />
                  </g>
                ))}
                ...
                <g transform="translate(180, 180) scale(2)" opacity="0.8">
                  ...
                  />
                  {/* Yogi Head */}
                  <circle cx="35" cy="18" r="4.2" fill="#175f52" />
                  {/* Torso */}
                  <path
                  ...
                  <path
                    ...
                    strokeLinecap="round"
                  />
                  <circle cx="53" cy="30" r="1.6" fill="#F5B860" />
                  {/* Back Arm */}
                  <path
            ...
            <div className="relative grid grid-cols-2 gap-3.5 sm:gap-4.5">
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 px-3.5 py-1.5 rounded-full bg-white/95 backdrop-blur-md border border-[#EBE5D8] shadow-md flex items-center gap-2 pointer-events-none">
                <span className="w-1.5 h-1.5 rounded-full bg-[#f22924] animate-pulse" />
