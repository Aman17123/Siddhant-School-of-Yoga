        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-end justify-between gap-5 mb-8 lg:mb-10 text-center lg:text-left">
          ...
          <div className="shrink-0 flex flex-wrap items-center justify-center gap-2.5 w-full sm:w-auto">
            <a
              ...
              className="group inline-flex items-center gap-2.5 sm:gap-3 px-3.5 sm:px-4 py-2 sm:py-2.5 rounded-xl bg-white border border-[#EBE5D8] hover:border-[#f22924]/40 shadow-xs hover:shadow-md transition-all duration-300"
              title="View all 48 reviews on Google for Siddhant School of Yoga"
            >
              {/* Google Official Vector Logo */}
              <div className="shrink-0 flex items-center justify-center w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-[#faf6ee] p-1 border border-stone-200">
                <Image
                  src="/logo/google.svg"
                  alt="Google"
                  width={22}
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group inline-flex items-center gap-2.5 sm:gap-3 px-3.5 sm:px-4 py-2 sm:py-2.5 rounded-xl bg-white border border-[#EBE5D8] hover:border-[#00B386]/40 shadow-xs hover:shadow-md transition-all duration-300"
              title="View TripAdvisor ratings for Siddhant School of Yoga"
            >
              <div className="shrink-0 flex items-center justify-center w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-[#e8f7f2] p-1 border border-[#00B386]/30">
                <Image
              ...
              <div className="flex flex-col text-left">
                <span className="text-[9.5px] sm:text-[10px] uppercase tracking-wider text-[#023D38] font-bold leading-none mb-0.5 font-figtree">
                  TripAdvisor
                </span>
        ...
        <div className="relative px-0 sm:px-5">
          ...
          {totalReviews > itemsPerPage && (
            <button
              ...
              className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-1 sm:-translate-x-4 w-9 h-9 rounded-full bg-white border border-[#EBE5D8] shadow-md hover:shadow-lg flex items-center justify-center text-[#55564c] hover:text-[#f22924] hover:border-[#f22924] transition-all z-20 cursor-pointer"
            >
          ...
          >
            {visibleReviews.map((card) => (
              <div
                key={card.id}
                className="bg-white rounded-2xl p-4 sm:p-5 border border-[#EBE5D8] shadow-xs hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between max-w-lg mx-auto w-full"
              >
                <div>
                  ...
                  <div className="relative">
                    ...
                    <p className="text-xs sm:text-[13px] text-[#44453c] font-figtree leading-relaxed italic line-clamp-4 min-h-[64px]">
          ...
          {totalReviews > itemsPerPage && (
            <button
              ...
              className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-1 sm:translate-x-4 w-9 h-9 rounded-full bg-white border border-[#EBE5D8] shadow-md hover:shadow-lg flex items-center justify-center text-[#55564c] hover:text-[#f22924] hover:border-[#f22924] transition-all z-20 cursor-pointer"
            >
