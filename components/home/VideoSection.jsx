...
export default function VideoSection() {
  ...
  return (
    <section
      id="videos"
      className="py-14 sm:py-16 lg:py-20 bg-[#FAF6EE] border-b border-[#EBE5D8]/80 relative overflow-hidden font-figtree"
    >
      {/* Subtle Background Glow */}
      <div className="absolute top-0 right-1/4 w-96 h-96 rounded-full bg-[#F5B860]/10 blur-3xl pointer-events-none" />
      <div className="absolute bottom-0 left-1/4 w-96 h-96 rounded-full bg-[#f22924]/5 blur-3xl pointer-events-none" />
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8 lg:mb-10 items-center md:items-end text-center md:text-left">
          ...
          <div className="shrink-0 flex justify-center md:justify-end w-full md:w-auto">
            <a
              ...
              className="inline-flex items-center gap-2.5 px-5 py-3 rounded-full bg-white hover:bg-[#f22924] text-[#1e2422] hover:text-white border border-[#EBE5D8] hover:border-[#f22924] text-xs sm:text-sm font-semibold transition-all duration-300 shadow-xs hover:shadow-md hover:-translate-y-0.5 group"
            >
              <FaYoutube className="w-4 h-4 text-[#f22924] group-hover:text-white transition-colors" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {videos.map((video) => (
            <div
              ...
              className="group cursor-pointer bg-white rounded-2xl overflow-hidden border border-[#EBE5D8] shadow-xs hover:shadow-xl transition-all duration-300 hover:-translate-y-1 flex flex-col justify-between"
            >
              {/* Thumbnail Container */}
              <div>
                <div className="relative w-full aspect-video bg-black overflow-hidden">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-[#f22924] text-white flex items-center justify-center shadow-lg group-hover:scale-110 group-hover:bg-[#d45d44] transition-all duration-300 pl-0.5">
                  ...
                  {/* Category Pill */}
                  <div className="absolute top-2.5 left-2.5 px-2.5 py-0.5 rounded-full bg-white/95 text-[#f22924] text-[10px] font-bold uppercase tracking-wider shadow-2xs">
                    {video.category}
                  </div>
                </div>
                ...
                <div className="p-4 sm:p-5">
                  <h3 className="font-belleza text-base sm:text-lg font-normal text-[#1e2422] group-hover:text-[#f22924] transition-colors line-clamp-2 leading-snug mb-2">
                    {video.title}
                  </h3>
              ...
              {/* Card Footer Action */}
              <div className="px-4 sm:px-5 pb-4 pt-1 flex items-center justify-between text-xs font-semibold text-[#f22924] border-t border-[#EBE5D8]/50">
        ...
        >
          ...
          >
            ...
            <button
              ...
              className="absolute top-3 right-3 z-20 w-10 h-10 rounded-full bg-black/70 hover:bg-[#f22924] text-white flex items-center justify-center transition-colors border border-white/20"
            >
              <X className="w-5 h-5" />
            </button>
