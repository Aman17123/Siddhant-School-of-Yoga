...
export default function VideoSection({
  ...
  return (
    <section
      id="videos"
      className="py-14 sm:py-16 lg:py-20 bg-[#f4efe6] border-b border-[#e3dac9]/80 relative overflow-hidden font-figtree"
    >
      {/* Subtle Background Glow */}
      <div className="absolute top-0 right-1/4 w-96 h-96 rounded-full bg-[#1c3b2b]/10 blur-3xl pointer-events-none" />
      <div className="absolute bottom-0 left-1/4 w-96 h-96 rounded-full bg-[#1c3b2b]/5 blur-3xl pointer-events-none" />
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8 lg:mb-10 items-center md:items-end text-center md:text-left">
          ...
          <div className="shrink-0 flex justify-center md:justify-end w-full md:w-auto">
            <a
              ...
              className="inline-flex items-center gap-2.5 px-5 py-3 rounded-full bg-[#fdfbf7] hover:bg-[#1c3b2b] text-[#1e2422] hover:text-white border border-[#e3dac9] hover:border-[#1c3b2b] text-xs sm:text-sm font-semibold transition-all duration-300 shadow-xs hover:shadow-md hover:-translate-y-0.5 group"
            >
              <FaYoutube className="w-4 h-4 text-[#1c3b2b] group-hover:text-white transition-colors" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {videos.map((video) => (
            <div
              ...
              className="group cursor-pointer bg-[#fdfbf7] rounded-2xl overflow-hidden border border-[#e3dac9] shadow-xs hover:shadow-xl transition-all duration-300 hover:-translate-y-1 flex flex-col justify-between"
            >
              {/* Thumbnail Container */}
              <div>
                <div className="relative w-full aspect-video bg-black overflow-hidden">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-[#1c3b2b] text-white flex items-center justify-center shadow-lg group-hover:scale-110 group-hover:bg-[#142b1e] transition-all duration-300 pl-0.5">
                  ...
                  {/* Category Pill */}
                  <div className="absolute top-2.5 left-2.5 px-2.5 py-0.5 rounded-full bg-white/95 text-[#1c3b2b] text-[10px] font-bold uppercase tracking-wider shadow-2xs">
                    {video.category}
                  </div>
                </div>
                ...
                <div className="p-4 sm:p-5">
                  <h3 className="font-belleza text-base sm:text-lg font-normal text-[#1e2422] group-hover:text-[#1c3b2b] transition-colors line-clamp-2 leading-snug mb-2">
                    {video.title}
                  </h3>
              ...
              {/* Card Footer Action */}
              <div className="px-4 sm:px-5 pb-4 pt-1 flex items-center justify-between text-xs font-semibold text-[#1c3b2b] border-t border-[#e3dac9]/50">
