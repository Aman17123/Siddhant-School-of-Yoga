      ...
      <Container>
        ...
        <div className="max-w-3xl mx-auto text-center mb-8 lg:mb-10">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full text-xs font-figtree font-semibold tracking-wider uppercase bg-[#f22924]/10 text-[#f22924] border border-[#f22924]/20 mb-3">
            ...
            <span>ASHRAM LIVING &amp; SATTVIC NOURISHMENT</span>
          </div>
          ...
          <p className="font-fortune text-xl sm:text-2xl text-[#d45d44] mb-3 tracking-wide">
            Experience the authentic discipline of Himalayan ashram life
          </p>
          ...
          <div className="lg:col-span-6 space-y-4">
            {stayFeatures.map((feat, i) => {
              ...
              return (
                <div
                  key={i}
                  className="p-5 rounded-2xl bg-white border border-[#EBE5D8] shadow-xs flex items-start gap-4 hover:shadow-md transition-shadow"
                >
                  <div className="w-11 h-11 rounded-xl bg-[#f22924]/10 text-[#f22924] flex items-center justify-center shrink-0 mt-0.5">
        ...
        <div className="p-7 sm:p-10 rounded-3xl bg-white border border-[#EBE5D8] shadow-sm font-figtree">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8 pb-6 border-b border-[#EBE5D8]">
            <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {schedule.map((s, idx) => (
              <div
                key={idx}
                className="p-4 rounded-2xl bg-[#FAF6EE]/60 border border-[#EBE5D8] flex flex-col justify-between"
              >
                <div>
