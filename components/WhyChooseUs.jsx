    ...
    >
      ...
      <Container className="relative z-10">
        ...
        <div className="text-center max-w-4xl mx-auto mb-8 lg:mb-10">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-figtree font-semibold tracking-[0.2em] uppercase bg-[#FAF6EE] text-[#f22924] border border-[#f5b860]/40 shadow-xs mb-3">
            <Sparkles className="w-3.5 h-3.5 text-[#f5b860]" />
            <span>AUTHENTIC HIMALAYAN DIFFERENTIATION</span>
          </div>
