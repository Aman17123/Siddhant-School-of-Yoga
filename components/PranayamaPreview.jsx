...
export default function PranayamaPreview() {
  ...
  return (
    <section className="py-14 sm:py-16 lg:py-20 bg-gradient-to-b from-[#FAF6EE] to-[#eef6f4] border-b border-[#EBE5D8]/70 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7">
            <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full text-xs font-figtree font-semibold tracking-wider uppercase bg-[#f22924]/10 text-[#f22924] border border-[#f22924]/20 mb-3">
              <Wind className="w-3.5 h-3.5 text-[#f22924]" />
              <span>World&apos;s First Breath-Focused Yoga School</span>
            </div>
            ...
            <p className="font-fortune text-xl sm:text-2xl text-[#d45d44] mb-3 tracking-wide">
              Prana is the very foundation of life, meditation, and healing
            </p>

            <p className="font-figtree text-sm sm:text-base text-stone-600 leading-relaxed mb-6 font-light">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
              {breathPillars.map((p, i) => (
                <div
                  key={i}
                  className="p-4 rounded-2xl bg-white border border-[#EBE5D8] shadow-xs hover:shadow-md transition-shadow"
                >
                  <div className="flex items-center gap-2 mb-1.5">
                    <CheckCircle2 className="w-4 h-4 text-[#f22924] shrink-0" />
                    <h4 className="font-belleza text-sm font-normal text-[#1e2422] tracking-wide">
                      {p.title}
                    </h4>
                  </div>
                  <p className="font-figtree text-xs text-stone-600 leading-relaxed pl-6">
                    {p.desc}
                  </p>
                </div>
              ))}
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 text-xs sm:text-sm font-figtree font-semibold text-[#f22924] hover:text-[#d45d44] px-4 py-3 transition-colors"
              >
            ...
            <div className="relative mx-auto max-w-sm lg:max-w-none">
              <div className="relative w-full aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl border-4 border-white">
                ...
                <div className="absolute bottom-6 left-6 right-6 text-white">
                  <span className="font-figtree text-[11px] uppercase tracking-widest text-[#f5b860] font-semibold block mb-1">
                    Daily Morning Sadhana
                  </span>
                  <p className="font-fortune text-base sm:text-lg leading-snug tracking-wide">
