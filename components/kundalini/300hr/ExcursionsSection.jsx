      ...
      <div className="max-w-[1320px] mx-auto px-4 sm:px-5 lg:px-2">
        <div className="text-center max-w-2xl mx-auto mb-8 lg:mb-10">
          ...
          <p className="text-sm sm:text-base text-stone-700 leading-relaxed font-medium">
            A real education never stops at the edge of the yoga hall. Woven through the 28 days is a short excursion trip and a handful of small rituals that tie your advanced Kundalini practice to the living culture all around you — for many students, these turn out to be the memories they hold onto longest.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div className="flex flex-col gap-4">
            <ExcursionCard
              num="03"
              tag="Some Mornings"
              title="Advanced Kundalini Practice on the Ganges Ghat"
              text="Some sessions leave the yoga hall entirely — advanced pranayama and chakra-balancing meditation right on the riverbank, with the Ganges moving past as your soundtrack."
              image="/images/excusrion-activity/yoga-on-ganga-ghat.jpg"
              alt="Advanced Kundalini practice on the Ganges riverbank in Rishikesh"
              heightClass="h-[220px] sm:h-[240px]"
            />
            <ExcursionCard
              num="04"
          ...
          <div className="flex flex-col gap-4">
            <ExcursionCard
              ...
              alt="Guided sunrise temple visit at Kunjapuri near Rishikesh"
              heightClass="h-[280px] sm:h-[420px]"
            />
            <ExcursionCard
              num="06"
              ...
              alt="Outdoor practice session on a nature walk by the Ganges river in Rishikesh"
              heightClass="h-[220px] sm:h-[240px]"
            />
          </div>
        </div>
