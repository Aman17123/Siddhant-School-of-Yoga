...
const badges = [
  ...
  { icon: Award, label: "Yoga Alliance RYS-300 Certificate" },
  { icon: Users, label: "Advanced · 200-Hour Graduates" },
];
...
export default function KundaliniHero() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await submitEnquiry({
        formSource: `Send Us a Message — Namaste! I'd like to know more about the 300-Hour Advanced Kundalini Yoga TTC in Rishikesh.`,
    ...
    <section className="relative min-h-fit lg:min-h-[640px] w-full flex items-center overflow-hidden bg-[#12261b]">
      <div className="absolute inset-0 z-0">
        <Image
          ...
          alt="Advanced Kundalini meditation and chakra balancing sadhana in Rishikesh"
          fill
          priority
          sizes="100vw"
          ...
          <div className="w-full lg:w-[58%] max-w-2xl">
            <div className="inline-flex items-center gap-2 mb-4">
              ...
              <span className="text-[11px] sm:text-xs font-figtree font-semibold uppercase tracking-[0.2em] text-[#e3dac9]">
                An Advanced Specialisation · Kundalini Awakening
              </span>
            </div>

            <h1 className="font-belleza tracking-wide text-white leading-[1.15] text-3xl sm:text-4xl lg:text-[52px]">
              300-Hour Advanced Kundalini Yoga Teacher Training in Rishikesh
            </h1>

            <p className="mt-5 text-sm sm:text-base font-figtree text-white/80 leading-relaxed max-w-xl">
              Kundalini Yoga is the yogic method to transform your potential energy to kinetic energy. Over twenty-eight days on the banks of the Ganga, 200-hour graduates go beyond discovering and awakening the chakras into balancing them fully and awakening Kundalini itself — Steps 3 and 4 of our Kundalini method.
            </p>
