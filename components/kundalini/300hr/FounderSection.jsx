...
export default function KundaliniFounderSection() {
  return (
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-4 max-w-lg mx-auto lg:max-w-none">
              <div className="relative aspect-[3/4] rounded-2xl overflow-hidden shadow-lg border-2 border-white">
                <Image
                  ...
                  alt="Acharya Siddhant in deep meditation and advanced Kundalini sadhana in Rishikesh"
                  fill
              ...
              <div className="relative aspect-[3/4] rounded-2xl overflow-hidden shadow-lg border-2 border-white mt-6 sm:mt-8">
                <Image
                  ...
                  alt="Acharya Siddhant guiding advanced students in Kundalini awakening practice"
                  fill
                  className="object-cover"
                  sizes="(max-width: 1024px) 50vw, 25vw"
                />
          ...
          <div className="lg:col-span-6 text-center lg:text-left">
            ...
            <div className="relative pl-5 py-4 border-l-4 border-[#1c3b2b] bg-[#f4efe6] rounded-r-2xl mb-6 pr-4 shadow-2xs text-left">
              ...
              <p className="font-figtree italic text-sm sm:text-base text-[#1e2422] leading-relaxed">
                &ldquo;Kundalini is not something you chase — it is something you finally allow yourself to feel, once the chakras are fully balanced.&rdquo;
              </p>
            ...
            <p className="font-figtree text-sm sm:text-base text-stone-600 leading-relaxed mb-8 font-medium">
              He personally teaches every 300-Hour Advanced Kundalini batch at Siddhant School of Yoga, taking 200-hour graduates beyond the foundation into balancing the chakras fully and awakening Kundalini itself — Steps 3 and 4 of our Kundalini method.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center lg:justify-start gap-4">
              ...
              <a
                href={whatsappLink(
                  "Namaste Acharya Siddhant! I would like to inquire about your Kundalini Yoga teachings and the 300-Hour Advanced Kundalini TTC in Rishikesh.",
                )}
                target="_blank"
