...
const badges = [
  ...
  { icon: Award, label: "Yoga Alliance USA RYS-200 Certified" },
  { icon: Users, label: "All Levels · Beginner to Advanced" },
];
          ...
          <div className="w-full lg:w-[58%] max-w-2xl">
            <div className="inline-flex items-center gap-2 mb-4">
              ...
              <span className="text-[11px] sm:text-xs font-figtree font-semibold uppercase tracking-[0.2em] text-[#e3dac9]">
                Full Certification · Kundalini Awakening
              </span>
            </div>
            ...
            <p className="mt-5 text-sm sm:text-base font-figtree text-white/80 leading-relaxed max-w-xl">
              Explore the untapped Kundalini Energy by different Yogic Practices and experience the Kundalini awakening. Over twenty-four days on the banks of the Ganga, complete your full RYT-200 certification while going deep into Steps 1 and 2 of our Kundalini method — discovering and awakening every one of your seven main chakras.
            </p>
