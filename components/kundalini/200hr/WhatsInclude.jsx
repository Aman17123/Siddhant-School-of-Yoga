...
const whatsIncludeTabs = [
  {
    ...
    items: [
      "24 days residential Kundalini yoga teacher training",
      "Yoga Alliance USA RYS-200 certificate",
    ...
    images: [
      { src: "/images/yoga-school-food-and-stay/siddhant-school-of-yoga-building-exterior.jpg", alt: "Ashram building exterior at Siddhant School of Yoga", caption: "Comfortable Stay" },
      { src: "/images/yoga-school-food-and-stay/yoga-school-sattvic-thali-rice-dal-raita.jpg", alt: "Vegetarian meals served at Siddhant School of Yoga", caption: "Sattvic Meals" },
      ...
      { src: "/images/gallery_images/yoga-teacher-training-certificate-ceremony-siddhant-school-rishikesh.webp", alt: "200-hour Kundalini RYT-200 certification ceremony", caption: "Certification" },
    ],
  },
  {
    ...
    images: [
      ...
      { src: "/images/namaste-prayer-by-ganga-river.jpg", alt: "Namaste prayer by the Ganga river, part of ashram life in Rishikesh", caption: "Ashram Life" },
...
export default function Kundalini200HourWhatsInclude() {
