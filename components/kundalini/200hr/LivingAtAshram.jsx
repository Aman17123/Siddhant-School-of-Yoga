...
const asks = [
  {
    ...
    desc: "Sadhana begins at 5:30 AM, and your full attention stays with it through the day.",
  },
  {
    icon: Ban,
    title: "Letting Habits Go",
    desc: "A willingness to set aside caffeine, distractions and old routines, for the full 24 days.",
  },
  {
    icon: Eye,
...
const gives = [
  {
    ...
    desc: "Chakra work and kundalini kriya, deepened across 24 days, that create change you can actually feel.",
  },
  {
    icon: User,
  ...
  {
    icon: Sparkles,
    title: "A Full Teaching Certification",
    desc: "Real tools for calm, clarity and emotional balance — plus a Yoga Alliance RYT-200 credential you carry home.",
  },
];

export default function Kundalini200HourLivingAtAshram() {
  return (
      ...
      <div className="relative z-10 max-w-[1320px] mx-auto px-6 sm:px-10 lg:px-16">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12 lg:mb-16">
          ...
          <p className="text-sm sm:text-base text-stone-700 leading-relaxed font-medium mt-4">
            There is something worth saying plainly, right at the start: these twenty-four days will ask something of you. This is not a retreat with a little breathwork bolted on, and we would rather you knew that before you booked than felt misled once you arrived. It is a fair trade, though. Here is both sides of it.
          </p>
        </div>
          ...
          <div className="relative mx-auto">
            <div className="relative w-[280px] sm:w-[340px] aspect-[3/4] rounded-t-[160px] rounded-b-2xl overflow-hidden border-4 border-[#fdfbf7] shadow-2xl">
              <Image
                ...
                alt="Kundalini sadhana and temple meditation practice at Siddhant School of Yoga"
                fill
