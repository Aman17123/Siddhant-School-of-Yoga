          ...
          <div className="lg:col-span-6 text-center lg:text-left">
            ...
            <div className="relative pl-5 py-4 border-l-4 border-[#1c3b2b] bg-[#f4efe6] rounded-r-2xl mb-6 pr-4 shadow-2xs text-left">
              ...
              <p className="font-figtree italic text-sm sm:text-base text-[#1e2422] leading-relaxed">
                &ldquo;Kundalini is not something you chase — it is something you finally allow yourself to feel, once the chakras are truly awake.&rdquo;
              </p>
            ...
            <p className="font-figtree text-sm sm:text-base text-stone-600 leading-relaxed mb-8 font-medium">
              He personally teaches every 100-Hour Kundalini batch at Siddhant School of Yoga, guiding each student through the traditional four-step path — discovering, awakening and balancing the chakras — before ever approaching Kundalini itself.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center lg:justify-start gap-4">
              ...
              <a
                href={whatsappLink(
                  "Namaste Acharya Siddhant! I would like to inquire about your Kundalini Yoga teachings and the 100-Hour Kundalini TTC in Rishikesh.",
                )}
                target="_blank"
