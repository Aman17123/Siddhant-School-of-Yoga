...
const quickFacts = [
  { icon: Clock, label: "Duration", value: "13 Days · Residential" },
  { icon: BarChart2, label: "Level", value: "Beginner to Intermediate" },
  { icon: Flame, label: "Focus", value: "Kundalini Asana, Pranayama & Meditation" },
  { icon: Calendar, label: "Schedule", value: "Arrive 2nd · Depart 16th · Starts 3rd of Every Month" },
];

const roomTiers = [
  { room: "Triple Sharing", price: "USD 300", reserve: "USD 100", onArrival: "USD 200" },
  { room: "Shared Room", price: "USD 500", reserve: "USD 100", onArrival: "USD 400", badge: "Most Popular" },
  { room: "Private Room", price: "USD 600", reserve: "USD 100", onArrival: "USD 500" },
];

const batches = [
  { batch: "July 2026", dates: "3rd Jul - 15th Jul 2026", status: "filling" },
  { batch: "August 2026", dates: "3rd Aug - 15th Aug 2026", status: "filling" },
  { batch: "September 2026", dates: "3rd Sep - 15th Sep 2026", status: "open" },
  { batch: "October 2026", dates: "3rd Oct - 15th Oct 2026", status: "open" },
  { batch: "November 2026", dates: "3rd Nov - 15th Nov 2026", status: "open" },
  { batch: "December 2026", dates: "3rd Dec - 15th Dec 2026", status: "open" },
  { batch: "January 2027", dates: "3rd Jan - 15th Jan 2027", status: "open" },
  { batch: "February 2027", dates: "3rd Feb - 15th Feb 2027", status: "open" },
  { batch: "March 2027", dates: "3rd Mar - 15th Mar 2027", status: "open" },
  { batch: "April 2027", dates: "3rd Apr - 15th Apr 2027", status: "open" },
  { batch: "May 2027", dates: "3rd May - 15th May 2027", status: "open" },
];
      ...
      <div className="max-w-[1320px] mx-auto px-4 sm:px-5 lg:px-2">
        <div className="text-center max-w-2xl mx-auto mb-10 lg:mb-14">
          ...
          <h2 className="text-2xl sm:text-3xl lg:text-[40px] font-belleza font-normal tracking-wide text-[#1e2422] leading-[1.2] drop-shadow-2xs">
            100-Hour Kundalini Yoga TTC in Rishikesh: Dates &amp; Fees
          </h2>
          <HeadingDivider />
          <p className="text-sm sm:text-base text-stone-700 leading-relaxed font-medium">
            The 100-Hour Kundalini TTC, the root of the Kundalini path. Everything you genuinely need for the thirteen days is already inside these numbers — from your room to your meals to your certificate.
          </p>
        </div>
        ...
        <div className="relative">
          <div className="relative h-56 sm:h-72 lg:h-80 w-full rounded-3xl overflow-hidden">
            <Image
              ...
              alt="Outdoor yoga class on the Ganga ghat near the Kundalini Yoga TTC ashram in Rishikesh"
              fill
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.3fr_0.8fr]">
              ...
              <div className="bg-[#1c3b2b] p-6 sm:p-7 flex flex-col justify-center gap-5">
                ...
                <p className="text-[11px] text-white/50 leading-relaxed pt-2 border-t border-white/10">
                  Fees include accommodation, three sattvic meals daily and study material. A USD 100 advance reserves your seat on any room type — the balance is paid on arrival.
                </p>
              </div>
              ...
              <div className="p-6 sm:p-7 flex flex-col items-center text-center gap-3">
                ...
                <a
                  href={whatsappLink(
                    "Namaste! I have a question about the 100-Hour Kundalini Yoga TTC dates and fees at Siddhant School of Yoga in Rishikesh.",
                  )}
                  target="_blank"
        ...
        <div className="mt-10 lg:mt-14 rounded-3xl border border-[#e3dac9] bg-white p-5 sm:p-8 overflow-x-auto">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-5">
            ...
            <span className="text-xs text-stone-500">
              Course runs the 3rd to the 15th · arrive on the 2nd
            </span>
          </div>
            ...
            <tbody>
              {batches.map((b) => (
                <tr key={b.batch} className="border-b border-[#e3dac9]/70 last:border-b-0">
                  ...
                  <td className="py-3 pr-4 text-sm text-stone-700 whitespace-nowrap">USD 300</td>
                  <td className="py-3 pr-4 text-sm text-stone-700 whitespace-nowrap">USD 500</td>
                  <td className="py-3 pr-4 text-sm text-stone-700 whitespace-nowrap">USD 600</td>
                  ...
                  <td className="py-3 text-right whitespace-nowrap">
                    <a
                      href={whatsappLink(
                        `Namaste! I would like to register for the ${b.batch} batch (${b.dates}) of the 100-Hour Kundalini Yoga TTC at Siddhant School of Yoga in Rishikesh.`,
                      )}
                      target="_blank"
                      rel="noopener noreferrer"
