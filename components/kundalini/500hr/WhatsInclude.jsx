...
const whatsIncludeTabs = [
  {
    ...
    items: [
      "About 8 weeks residential Master Kundalini yoga course",
      "Yoga Alliance USA RYT-500 Certificate",
      "Triple sharing, shared and private accommodation options",
    ...
    images: [
      { src: "/images/yoga-school-food-and-stay/yoga-school-twin-sharing-room.jpg", alt: "Twin sharing room at Siddhant School of Yoga", caption: "Comfortable Stay" },
      ...
      { src: "/images/namaste-pose-kunjapuri-temple-sunrise-rishikesh.jpg", alt: "500-hour Master Kundalini RYT-500 sunrise certification ceremony", caption: "Certification" },
    ],
  },
  {
    ...
    images: [
      ...
      { src: "/images/rishikesh/lord_shiva_rishikesh.png", alt: "Sacred Shiva statue in Rishikesh", caption: "Ashram Life" },
      { src: "/images/yoga-students-namaste-ganga-river-rishikesh.jpg", alt: "Namaste pose practice by the Ganges river", caption: "Personal Practice" },
      { src: "/images/seated-stretching-yoga-class-garden-rishikesh.jpg", alt: "Master Kundalini philosophy class in the garden", caption: "Philosophy" },
    ],
  },
  {
    label: "What To Bring",
    ...
    images: [
      { src: "/images/yoga-students-indian-cooking-class-rishikesh.jpg", alt: "Students bonding during a cultural cooking class in Rishikesh", caption: "Community" },
      ...
      { src: "/images/gallery_images/yoga-asana-practice-riverside-rishikesh.webp", alt: "Master Kundalini asana practice in Rishikesh", caption: "Your Journey" },
    ],
  },
];
