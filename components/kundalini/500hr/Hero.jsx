...
const badges = [
  ...
  { icon: Users, label: "Beginner to Advanced · Dual Immersion" },
];

export default function KundaliniFiveHundredHourHero() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await submitEnquiry({
        formSource: `Send Us a Message — Namaste! I'd like to know more about the 500-Hour Master Kundalini Yoga TTC in Rishikesh.`,
    ...
    <section className="relative min-h-fit lg:min-h-[640px] w-full flex items-center overflow-hidden bg-[#12261b]">
      <div className="absolute inset-0 z-0">
        <Image
          ...
          alt="Kundalini meditation and Samadhi sadhana in Rishikesh"
          fill
          priority
          sizes="100vw"
          ...
          <div className="w-full lg:w-[58%] max-w-2xl">
            <div className="inline-flex items-center gap-2 mb-4">
              ...
              <span className="text-[11px] sm:text-xs font-figtree font-semibold uppercase tracking-[0.2em] text-[#e3dac9]">
                The Complete 4-Step Journey · Kundalini Mastery
              </span>
            </div>

            <h1 className="font-belleza tracking-wide text-white leading-[1.15] text-3xl sm:text-4xl lg:text-[52px]">
              500-Hour Master Kundalini Yoga Teacher Training in Rishikesh
            </h1>

            <p className="mt-5 text-sm sm:text-base font-figtree text-white/80 leading-relaxed max-w-xl">
              &ldquo;The highest level of Kundalini energy is called Samadhi.&rdquo; Across about eight uninterrupted weeks on the banks of the Ganga, you&apos;ll walk the complete four-step path — discover, awaken and balance your chakras, then safely awaken Kundalini itself — combining our 200-hour and 300-hour Kundalini courses into one immersive mastery journey.
            </p>
