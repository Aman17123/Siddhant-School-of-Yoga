...
const afterCoursePoints = [
  {
    icon: Award,
    title: "Register as an RYT-500 With Yoga Alliance",
    text: "This complete 500-hour course covers all four steps of our Kundalini method and awards a Yoga Alliance USA RYT-500 certificate — the highest teaching credential Yoga Alliance offers.",
  },
  {
    icon: MessageCircle,
  ...
  },
  {
    ...
    text: "The USD 400 deposit is non-refundable. In a genuine emergency, you can postpone within the current year — your deposit stays valid for 12 months and can even be transferred to a friend.",
  },
];
