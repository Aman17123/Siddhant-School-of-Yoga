        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-4 max-w-lg mx-auto lg:max-w-none">
              <div className="relative aspect-[3/4] rounded-2xl overflow-hidden shadow-lg border-2 border-white">
                <Image
                  ...
                  alt="Acharya Siddhant in deep meditation and master-level Kundalini sadhana in Rishikesh"
                  fill
              ...
              <div className="relative aspect-[3/4] rounded-2xl overflow-hidden shadow-lg border-2 border-white mt-6 sm:mt-8">
                <Image
                  ...
                  alt="Acharya Siddhant guiding students through the complete Kundalini journey"
                  fill
                  className="object-cover"
                  sizes="(max-width: 1024px) 50vw, 25vw"
                />
          ...
          <div className="lg:col-span-6 text-center lg:text-left">
            ...
            <p className="font-figtree text-sm sm:text-base text-stone-600 leading-relaxed mb-8 font-medium">
              He personally guides every 500-Hour Master Kundalini batch at Siddhant School of Yoga, taking students through all four steps of our Kundalini method — discovering, awakening and balancing the chakras, and finally awakening Kundalini itself — in one uninterrupted journey.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center lg:justify-start gap-4">
              ...
              <a
                href={whatsappLink(
                  "Namaste Acharya Siddhant! I would like to inquire about your Kundalini Yoga teachings and the 500-Hour Master Kundalini TTC in Rishikesh.",
                )}
                target="_blank"
