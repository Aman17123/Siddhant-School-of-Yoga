...
const asks = [
  {
    icon: Sunrise,
    title: "Early Mornings, Every Day",
    desc: "Sadhana begins at 6 AM and continues without a gap for about eight weeks — your full attention stays with it.",
  },
  {
    icon: Ban,
    title: "Letting Habits Go, For Longer",
    desc: "A willingness to set aside caffeine, distractions and old routines — not for a fortnight, but for the whole journey.",
  },
  {
    icon: Eye,
    title: "Turning Inward, Repeatedly",
    desc: "Ready to sit with yourself in meditation again and again, as the practice deepens week after week.",
  },
];
...
const gives = [
  {
    icon: Flame,
    title: "A Complete Energetic Transformation",
    desc: "All four steps of chakra and kundalini work, taken through to the awakening of Kundalini itself.",
  },
  {
    icon: User,
    title: "A Lasting Practice Habit",
    desc: "Eight uninterrupted weeks are long enough to turn practice into identity, not just routine.",
  },
  {
    icon: Sparkles,
    title: "Mastery, Not Just Introduction",
    desc: "Real tools for calm, clarity and advanced energy work you carry home and can teach to others.",
  },
];
      ...
      <div className="relative z-10 max-w-[1320px] mx-auto px-6 sm:px-10 lg:px-16">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12 lg:mb-16">
          ...
          <p className="text-sm sm:text-base text-stone-700 leading-relaxed font-medium mt-4">
            There is something worth saying plainly, right at the start: these roughly eight weeks will ask something real of you. This is not a retreat with a little breathwork bolted on, and we would rather you knew that before you booked than felt misled once you arrived. It is a complete master journey, and a fair trade. Here is both sides of it.
          </p>
        </div>
          ...
          <div className="relative mx-auto">
            <div className="relative w-[280px] sm:w-[340px] aspect-[3/4] rounded-t-[160px] rounded-b-2xl overflow-hidden border-4 border-[#fdfbf7] shadow-2xl">
              <Image
                ...
                alt="Kundalini sadhana and focused asana practice at Siddhant School of Yoga"
                fill
        ...
        <div className="text-center max-w-xl mx-auto mt-16 lg:mt-20">
          ...
          <p className="text-base sm:text-lg font-belleza italic text-[#b85c00] leading-relaxed">
            This training was never about becoming someone new. It is about completing the journey from dormant energy to Samadhi, one uninterrupted step at a time.
          </p>
        </div>
      </div>
    </section>
