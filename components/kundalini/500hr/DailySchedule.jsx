      ...
      <div className="max-w-[1320px] mx-auto px-4 sm:px-5 lg:px-2">
        <div className="text-center max-w-2xl mx-auto mb-8 lg:mb-10">
          ...
          <h2 className="text-2xl sm:text-3xl lg:text-[40px] font-belleza font-normal tracking-wide text-[#1e2422] leading-[1.2] drop-shadow-2xs">
            Daily Schedule of the 500-Hour Master Kundalini Yoga TTC
          </h2>
          <HeadingDivider />
          <p className="text-sm sm:text-base text-stone-700 leading-relaxed font-medium">
            People always want to know what the days really feel like, so here is the shape of one — the same disciplined rhythm across all four steps of our Kundalini method, sustained over about eight uninterrupted weeks.
          </p>
        </div>
