    ...
    >
      ...
      <Container className="relative z-10">
        ...
        <div className="w-full mb-8 lg:mb-10">
          <div className="inline-flex items-center gap-1.5 px-3 py-0.5 rounded-full text-xs font-figtree font-semibold tracking-wider uppercase bg-white/95 backdrop-blur-xs text-[#f22924] border border-[#f5b860]/50 shadow-xs mb-3">
            <Flame className="w-3.5 h-3.5 text-[#f22924]" />
            <span>Sacred Energy Awakening</span>
          </div>

          <h2 className="text-2xl sm:text-3xl lg:text-[40px] font-belleza font-normal tracking-wide text-[#1e2422] leading-[1.2] mb-2 drop-shadow-xs">
            Kundalini Yoga Teacher Training in Rishikesh
          </h2>

          <p className="font-fortune text-lg sm:text-xl md:text-2xl text-[#d45d44] mb-3 tracking-wide leading-snug drop-shadow-xs">
            Awaken the dormant divine motherly energy within you
          </p>

          <p className="font-figtree text-sm sm:text-base text-stone-800 leading-relaxed font-normal w-full block bg-white/80 backdrop-blur-xs p-3 sm:p-3.5 rounded-xl border border-white/80 shadow-2xs">
