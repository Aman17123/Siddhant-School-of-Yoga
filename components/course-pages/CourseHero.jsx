...
import { ArrowRight, Send, Loader2, Sunrise, Sparkles, Flame, Clock, Award, Users, MonitorPlay } from "lucide-react";
import { submitEnquiry } from "@/lib/submitEnquiry";
import SuccessModal from "@/components/SuccessModal";

const ICONS = { Sunrise, Sparkles, Flame, Clock, Award, Users, MonitorPlay };
...
export default function CourseHero({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await submitEnquiry({
        formSource: `Send Us a Message — ${title}`,
        ...
        <div className="flex flex-col lg:flex-row lg:items-center gap-10 lg:gap-14">
          ...
          <div className="w-full lg:w-[58%] max-w-2xl">
            <div className="inline-flex items-center gap-2 mb-4">
              {KickerIcon && <KickerIcon className="w-4 h-4 text-[#e08a3e]" />}
