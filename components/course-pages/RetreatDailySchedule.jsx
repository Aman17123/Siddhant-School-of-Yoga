...
// Same site-wide daily schedule used across every retreat page — mirrors
// components/kundalini/DailySchedule.jsx's 4-card Morning/Mid-Day/Afternoon/
// Evening pattern exactly.
const periods = [
  {
    icon: Sunrise,
    label: "Morning",
    ...
    items: [
      ...
      { time: "7:00 – 8:00 AM", text: "Pranayama / bandha / mudra" },
    ],
  },
  {
    icon: Sun,
    ...
    theme: "mist",
    items: [
      { time: "8:15 – 9:45 AM", text: "Hatha Yoga with alignment" },
      { time: "9:45 – 10:30 AM", text: "Breakfast and karma yoga" },
      { time: "10:30 – 11:30 AM", text: "Gratitude course for peace, happiness and all positive results" },
  ...
  },
  {
    ...
    items: [
      ...
      { time: "2:30 – 3:30 PM", text: "Yoga Nidra / relaxation" },
      { time: "3:30 – 4:30 PM", text: "Philosophy with Siddhant Ji — Patanjali / chakra / Kundalini / Samadhi" },
      { time: "4:30 – 4:45 PM", text: "Tea time" },
    ],
  },
  {
    icon: Moon,
    ...
    theme: "dark",
    items: [
      { time: "4:45 – 5:45 PM", text: "Meditation" },
      { time: "5:45 – 7:15 PM", text: "Ashtanga Vinyasa" },
...
export default function RetreatDailySchedule({
  title = "Daily Schedule of the Retreat",
  bgClassName = "bg-[#fdfbf7]",
}) {
  return (
    <section id="schedule" className={`scroll-mt-28 py-14 sm:py-16 lg:py-20 ${bgClassName} border-b border-[#e3dac9]/70 font-figtree`}>
      <div className="max-w-[1320px] mx-auto px-4 sm:px-5 lg:px-2">
        <div className="text-center max-w-2xl mx-auto mb-8 lg:mb-10">
          ...
          <p className="text-sm sm:text-base text-stone-700 leading-relaxed font-medium">
            People always want to know what the days really feel like, so here is the shape of one — calm, structured and never rushed.
          </p>
        </div>
        ...
        <div className="text-center max-w-2xl mx-auto mt-10 lg:mt-12">
          <p className="mt-4 text-sm text-stone-500">
            ...
            This is a sample schedule and may vary according to the practitioners&apos; needs.
          </p>
        </div>
      </div>
    </section>
